...
const stats = [
  {
    value: '55%',
    label: 'faster task completion with GitHub Copilot in controlled tests (GitHub Research, 2024).',
  },
  {
    value: '25%',
    label: 'of YC W25 startups reported ~95% AI-generated codebases (TechCrunch/CNBC, 2025).',
  },
  {
    value: 'Now',
    label: 'Agentic workflows are turning design intent directly into working interfaces.',
  },
]
  ...
  return (
    <main className="page">
      ...
      >
        ...
        <h1>
          Building Web Apps <span>Without Coding</span>
        </h1>
        <p className="lead">
          An editorial workshop on vibecoding, AI agents and the new design role: from concept direction to real
          execution in code.
        </p>
      </motion.section>
      ...
      >
        <article>
          ...
          <p>
            AI has changed the build loop. You can now go from brief to interface in hours, not weeks. For Business
            Designers, this shifts value toward vision, taste, systems thinking and the ability to direct agents with
            precision.
          </p>
          <p>
            In this session, students learn how to execute ideas themselves — turning strategy and storytelling into
            live products.
          </p>
        </article>
        <article className="teacher-card">
          ...
          <p>
            Digital product specialist based in Barcelona. Currently at <strong>Runroom</strong>, with a background in web
            development and product execution.
          </p>
          <a href="https://www.linkedin.com/in/jesauraoller/" target="_blank" rel="noreferrer">
            LinkedIn profile ↗
          </a>
        </article>
      </motion.section>
